		...
		<li <?php bp_member_class( array('col_item') ); ?>>
			...
			<div class="member-inner-list" style="<?php rh_cover_image_url( 'members', 120, true ); ?>">
				...
				<div class="item">
					...
					<div class="star-small mb10"><?php $producto = xprofile_get_field_data(3, $author_ID);  echo (strlen($producto) > 120  ? (substr($producto, 0, 120).'...'): $producto ); ?></div>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( "Sorry, no members were found.", 'rehub-theme' ); ?></p>
	</div>
